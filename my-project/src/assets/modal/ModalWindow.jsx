            ...
            <div className="flex flex-col justify-between rounded-xl p-5   backdrop-blur-xl bg-white/10 w-[90vw] h-[90vh] m-10 z-20">
              ...
              <div className="h-[25%] flex flex-row justify-between">
                <div className="w-[30%] pl-5 ">
                  <div className="uppercase text-sm">ReBranding</div>
                  <div className="uppercase text-4xl">C3 Tech</div>
                  <p className="text-sm py-5">
                    Aqui você encontrará uma coleção diversificada de projetos
                    em que trabalhei ao longo dos anos. Meu portfólio abrange
                    uma ampla gama de trabalhos, desde branding até
                    desenvolvimento web.
                  </p>
                </div>
              </div>
