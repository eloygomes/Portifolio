const roadmap = [
  {
    ...
    period: "2016 — 2025",
    summary:
      "Minha jornada começou pelo design gráfico e direção de arte, evoluindo para UI Design e testes de usabilidade.",
    courses: [
      {
  ...
  },
  {
    ...
    period: "2017 — 2019",
    summary:
      "Transição para o desenvolvimento web com HTML, CSS, JavaScript e ferramentas clássicas do front-end.",
    courses: [
  ...
  },
  {
    ...
    period: "2020 — 2025",
    summary:
      "Aprofundamento em React, TypeScript, testes, arquitetura e integração de front-end com APIs.",
    courses: [
      { title: "React JS", school: "Udemy", date: "Dez/2020" },
      { title: "Python 2.0", school: "Udemy", date: "Fev/2021" },
      { title: "MySQL", school: "Udemy", date: "Fev/2021" },
  ...
  },
  {
    ...
    period: "2023 — 2025 ",
    summary:
      "Evolução para full stack: Node, TypeScript, Python, bancos relacionais e NoSQL, containers, servidores e comunicação em tempo real.",
    courses: [
      {
        title:
